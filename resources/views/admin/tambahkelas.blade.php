...
<head>
  ...
  <title>Tambah Kelas Pengguna</title>
        ...
        <div class="testbox">
            <form action="" method="POST" enctype="multipart/from-data">
              ...
              <div class="form-group">
                <label for="user_id">ID Pelajar</label>
                <input type="text" class="form-control" id="user_id" name="user_id">
              </div>
              <div class="form-group">
                <label for="id">Pilih Kelas</label>
                <select class="form-control" id="id" name="id">
                    @foreach ($dataLangganan as $d)
                    <option value="{{$d->id}}">{{$d->nama_langganan}}</option>
                    @endforeach
                  
                </select>
              </div>
              <div class="form-group">
                <input type="submit" class="btn btn-primary btn-lg btn-block" value="Tambahkan">
              </div>
            </form>
          </div>
      </div>
